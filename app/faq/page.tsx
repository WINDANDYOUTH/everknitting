...
export const metadata: Metadata = {
  title: "Frequently Asked Questions | Ever Knitting",
  description: "Find answers to common questions about our custom knitwear manufacturing services, MOQs, lead times, and shipping.",
};
  ...
  return (
    <div className="bg-navy min-h-screen text-cashmere">
      ...
      <section className="py-16 px-6 text-center">
        ...
        <a href="/contact-us" className="inline-block px-8 py-3 rounded-xl border border-copper text-copper font-medium hover:bg-copper hover:text-navy transition-colors">
          Contact Support
        </a>
      </section>
    </div>
