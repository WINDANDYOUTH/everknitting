...
export const metadata: Metadata = {
  title: "Premium Knitting Materials | Exquisite Yarns & Blends",
  description: "Explore our curated selection of premium materials including cashmere, merino wool, cotton, and sustainable blends for high-end knitwear.",
};
